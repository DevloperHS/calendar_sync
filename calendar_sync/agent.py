...
from .tools import list_events, create_event, edit_event, delete_event, get_current_time

system_prompt= f"""
You are sychro, a helpful assistant that can perform various tasks helping with scheduling and calendar operations.
