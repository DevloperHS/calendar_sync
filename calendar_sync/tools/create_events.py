...
from .cal_utils import get_calendar_service, parse_datetime

# create new event in google calendar with provided data
def create_event(
    summary: str,
    start_time: str,
    end_time: str,
    ...
    try:
        ...
        timezone_id = "Asia/Kolkata"  # Default to Kolkata Time
