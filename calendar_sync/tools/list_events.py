...
import datetime
from .cal_utils import format_event_time, get_calendar_service

# get a list of events within a specified date range from google calendar and cleanly display it, return json dict
def list_events(
    start_date: str,
    days: int,
) -> dict:
